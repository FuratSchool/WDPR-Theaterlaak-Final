        ...
        <section class="uitgelichteVoorstellingen mb-3">
          ...
          <div class="col-md-12 text-end">
            <Link
              to="/Voorstellingen"
              type="button"
              class="btn-custom btn btn-outline-info btn-outline-purple mb-3"
            >
              Bekijk hier alle voorstellingen
            </Link>
          </div>
          <div class="row mb-3">
            <div class="col-md-4">
              <div class="card card-custom card-border-gradient">
                ...
                <div class="card-body">
                  ...
                  <p>
                    ...
                    Nunc vitae nisl nisi. Proin elementum ante velit, et
                    vehicula nisi porttitor vel. Etiam sed tristique nisi.
                  </p>
                  <button
                    type="button"
